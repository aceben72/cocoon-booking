                          ...
                          {editingId === appt.id ? (
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-sm pt-2 border-t border-[#f0ebe4] mt-1">
                              ...
                              {(() => {
                                ...
                                return (
                                  <div className="col-span-2 sm:col-span-4">
                                    <div className="text-xs uppercase tracking-wider text-[#7a6f68] mb-1.5">Intake Form</div>
                                    <div className="flex items-center gap-2 flex-wrap">
                                      {intake.status === "pending" ? (
                                        <>
                                          ...
                                          <a
                                            href={`${appUrl}/intake/${intake.token}`}
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="inline-flex items-center gap-1 px-3 py-1 rounded-lg text-xs font-medium
                                                       bg-[#044e77] text-white hover:bg-[#033d5c] transition-colors"
                                          >
                                            Open Intake Form
                                        ...
                                        <span className={`inline-block px-2 py-0.5 rounded-full border text-xs font-medium
                                          ...
                                          {intake.status === "acknowledged" ? "Form Acknowledged" : "Form Submitted"}
                                        </span>
                                      )}
                                    </div>
                                  </div>
